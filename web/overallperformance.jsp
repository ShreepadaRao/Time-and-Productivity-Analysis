        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="overallperformance.jsp">Overall Performance</a></li>
                        ...
                        <p>
                            ...
                            <%
                                try 
                                {
                                    ...
                                    if (rs.next()) 
                                    {
                                        ...
                                        {
                                            Double rating = rs.getDouble("learning") 
                                                    + rs.getDouble("listening") 
                                                    + rs.getDouble("communication")
                                                    + rs.getDouble("answering")
                                                    + rs.getDouble("assignment")
                                                    + rs.getDouble("overallrating") * 5;
                                            
                                            map = new HashMap<Object,Object>(); map.put("label", "OverAll Rating"); 
                                            map.put("y", rating);
                            ...
                            <script type="text/javascript">
                                ...
                                var chart = new CanvasJS.Chart("chartContainer", {
                                        ...
                                        exportFileName: "Overall Performance Graph",
                                        exportEnabled: true,
                                        title:{
                                                text: "Overall Performance Graph"
                                        },
                                        data: [{
                                                type: "pie",
                                                showInLegend: true,
