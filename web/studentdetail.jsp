        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="studentdetail.jsp">Student Details</a></li>
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <%
                                ...
                                try {
                                    String sql = "select stu.Studentname, cou.coursename ,stu.DOB, stu.Emailid from student as stu left join  course as cou on cou.courseid  = stu.courseid where stu.username = '" + user + "'";
