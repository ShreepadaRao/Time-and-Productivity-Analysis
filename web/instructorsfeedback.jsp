        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="instructorsfeedback.jsp">Add Feedback</a></li>
                ...
                <div class="news">
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <form action="codeinstructorsfeedback.jsp" method="post">

                                <table border="0px" align="center">

                                    <tr>
                                        <td><p>Instructor <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="instructor" style="width:415px;">
                                    ...
                                    <tr>
                                        <td><p>Concept Explanation <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="concept" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                    ...
                                    <tr>
                                        <td><p>Practical Explanation <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="practical" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                                        String sql1 = "select * from ratingdetails";
                                    ...
                                    <tr>
                                        <td><p>Example Explanation <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="example" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                                        String sql1 = "select * from ratingdetails";
