        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="academicperformance.jsp">Academic Performance</a></li>
                ...
                <div class="news">
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <form action="codeacademicperformance.jsp" method="post">
                                ...
                                <table border="0px" align="center">
                                    ...
                                    <tr>
                                      <td><p>Course <span style="color: red;">*</span>:</p></td>
                                      <td>
                                          <select name="course" style="width:415px;">
                                              <option value="select">-Select-</option>
                                              <%
                                                  try {
                                    ...
                                    <tr>
                                        <td><p>Percentage <span style="color: red;">*</span>:</p></td>
                                        <td><input type="text" name="percentage" size="54px" autocomplete="true"/></td>
                                    </tr>

                                    <tr>
                                      <td><p>Year <span style="color: red;">*</span>:</p></td>
                                      <td>
                                          <select name="academicyear" style="width:415px;">
                                              <option value="select">-Select-</option>
                                              <%
                                                  try {
                                                      String sql1 = "select * from yeardetails";
                                                      DatabaseFile obj1 = new DatabaseFile();
                                                      ResultSet rs1 = obj1.codeselect(sql1);
                                                      while (rs1.next()) {
                                              %>
