        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="viewextraactivities.jsp">View Activities</a></li>
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <%
                                ...
                                out.println("<th>Title/Topic/Name</th>");
                                out.println("<th>Domain/Subject</th>");
                                out.println("<th>Place/Venue</th>");
                                out.println("<th>Description</th>");
                                out.println("<th>Attended/Published Date</th>");
                                out.println("<th>Recorded Date</th>");
                                out.println("<th>Delete</th>");
                                out.println("<tr>");

                                try {
                                    String sql = "SELECT e.ExtraId, c.categoryname, e.Name, e.Subject, e.Venue, e.Description, e.AttendedDate, e.RecordedDate FROM instructor_extracurricular AS e LEFT JOIN category AS c ON c.categoryid = e.categoryid LEFT JOIN instructor AS i ON i.Instructorid = e.Instructorid WHERE i.username = '" + user + "' ORDER BY e.RecordedDate DESC";
                                    ...
                                    while (rs.next()) {
                                        ...
                                        out.println("<td>" + rs.getString("AttendedDate") + "</td>");
                                        out.println("<td>" + rs.getString("RecordedDate") + "</td>");
                                        out.println("<td><a href='codeExtraDelete.jsp?index=" + rs.getInt("ExtraId") + "'><img src='images/Delete.png'></img></a></td>");
                                        out.println("</tr>");
                                    }
