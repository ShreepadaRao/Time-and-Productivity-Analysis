        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="viewacademicperformance.jsp">View Academic Performance</a></li>
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <%
                                ...
                                out.println("<th>Overall Percentage(Average)</th>");
                                ...
                                try {
                                    String sql = "SELECT a.AcademicId, i.InstructorName, c.coursename, s.subjectname, a.Percentage, y.year, a.RecordedDate FROM instructor_academicdetails AS a LEFT JOIN course AS c ON c.courseid = a.courseid LEFT JOIN subject AS s ON s.subjectid = a.subjectid LEFT JOIN instructor AS i ON i.Instructorid = a.Instructorid LEFT JOIN yeardetails AS y ON y.yearid = a.Year ORDER BY a.RecordedDate DESC";
                                    ...
                                    while (rs.next()) {
                                        ...
                                        out.println("<td><a href='codeAcademicDelete.jsp?index=" + rs.getInt("AcademicId") + "'><img src='images/Delete.png'></img></a></td>");
                                        out.println("</tr>");
                                    }
