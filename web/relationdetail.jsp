        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="relationdetail.jsp">Student Details</a></li>
                    <li><a href="Attendancecalculation.jsp">Total Attendance</a></li>
                    <li><a href="changeparent.jsp">Change Password</a></li>
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <%
                                ...
                                try {
                                    String sql = "select stu.Studentname, cou.coursename ,stu.DOB, stu.Emailid from parents as par left join  student as stu on  stu.Studentid = par.Studentid left join  course as cou on cou.courseid  = stu.courseid  where par.username = '" + user + "'";
                                    DatabaseFile obj = new DatabaseFile();
                                    ResultSet rs = obj.codeselect(sql);
                                    while (rs.next()) {
                                        out.println("<tr>");
                                        out.println("<td>" + g++ + "</td><td>" + rs.getString(1) + "</td><td>" + rs.getString(2) + "</td><td>" + rs.getDate(3) + "</td><td>" + rs.getString(4) + "</td>");
                                        out.println("</tr>");
                                    }
