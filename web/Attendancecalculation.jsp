        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="Attendancecalculation.jsp">Total Attendance</a></li>
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <%
                                ...
                                try {
                                    String sql = "SELECT stu.Studentname , sub.subjectname, att.Status FROM attendance AS att LEFT JOIN subject AS sub ON sub.subjectid = att.subjectid LEFT JOIN student AS stu ON stu.Studentid = att.Studentid LEFT JOIN parents AS par ON par.Studentid = att.Studentid WHERE par.username = '" + user + "'";
