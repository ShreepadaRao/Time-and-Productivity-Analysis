        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="updatestudentdetails.jsp">Change Password</a></li>
                ...
                <div class="news">
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <form action="codechangestudent.jsp" method="post">
                                <table border="0px" align="center">
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            String sql = "select * from student where username = '" + session.getAttribute("x").toString() + "'";
