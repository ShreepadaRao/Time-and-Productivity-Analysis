        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li><a href="StudentAttendance.jsp">Staff TimeTable</a></li>
                    ...
                    <li class="current_page_item"><a href="updatestaffdetail.jsp">Change Password</a></li>
                ...
                <div class="news">
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <form action="codechangestaff.jsp" method="post">
                                <table border="0px" align="center">
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            String sql = "select * from instructor where username = '" + session.getAttribute("z").toString() + "'";
