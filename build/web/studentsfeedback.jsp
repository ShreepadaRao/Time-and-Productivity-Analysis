        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="studentsfeedback.jsp">Add Feedback</a></li>
                ...
                <div class="news">
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <form action="codestudentsfeedback.jsp" method="post">

                                <table border="0px" align="center">

                                    <tr>
                                        <td><p>Student <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="student" style="width:415px;">
                                    ...
                                    <tr>
                                        <td><p>Subject <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="subject" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                    ...
                                    <tr>
                                        <td><p>Learning <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="learning" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                                        String sql1 = "select * from ratingdetails";
                                                        DatabaseFile obj1 = new DatabaseFile();
                                                        ResultSet rs1 = obj1.codeselect(sql1);
                                                        while (rs1.next()) {
                                                %>
                                    ...
                                    <tr>
                                        <td><p>Listening <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="listening" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                                        String sql1 = "select * from ratingdetails";
                                    ...
                                    <tr>
                                        <td><p>Communication <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="communication" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                                        String sql1 = "select * from ratingdetails";
                                    ...
                                    <tr>
                                        <td><p>Answering <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="answering" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                                        String sql1 = "select * from ratingdetails";
                                    ...
                                    <tr>
                                        <td><p>Assignment <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="assignment" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                                        String sql1 = "select * from ratingdetails";
                                    ...
                                    <tr>
                                        <td><p>Overall Rating <span style="color: red;">*</span>:</p></td>
                                        <td>
                                            <select name="overallrating" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                                        String sql1 = "select * from ratingdetails";
                                    ...
                                    <tr>
                                        <td>Feedback:</td>
                                        <td><textarea cols="53" rows="6" name="feedback"></textarea></td>
                                    </tr>
