        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li  class="current_page_item"><a href="Admincalculation.jsp">Whole Attendance</a></li>
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <%
                                ...
                                try {
                                    String sql = "SELECT count(*) as c, stu.Studentname , sub.subjectname, att.Status FROM attendance AS att LEFT JOIN subject AS sub ON sub.subjectid = att.subjectid LEFT JOIN student AS stu ON stu.Studentid = att.Studentid group by stu.Studentname,sub.subjectid";
                                    DatabaseFile obj = new DatabaseFile();
                                    ResultSet rs = obj.codeselect(sql);
                                    while (rs.next()) {
                                        out.println("<tr>");
                                        out.println("<td>" + g++ + "</td><td>" + rs.getInt(1) + "</td><td>" + rs.getString(2) + "</td><td>" + rs.getString(3) + "</td><td>" + rs.getString(4) + "</td>");
                                        out.println("</tr>");
                                    }
