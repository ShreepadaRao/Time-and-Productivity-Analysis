        ...
        <div id="header">
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="applyleave.jsp">Apply Leave</a></li>
                ...
                <div class="news">
                    ...
                    <div class="entry">
                        <p>
                            ...
                            <form action="codeapplyleave.jsp" method="post">
                                ...
                                <table border="0px" align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="leavetype" style="width:415px;">
                                                <option value="select">-Select-</option>
                                                <%
                                                    try {
                                                        String sql1 = "select * from leavetype";
                                    ...
                                    <tr>
                                        <td>Reason:</td>
                                        <td><textarea cols="53" rows="6" name="reason"></textarea></td>
                                    </tr>

                                    <tr>
                                        <td><p>Leave Date <span style="color: red;">*</span>:</p></td>
